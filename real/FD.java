...
public class FD extends JInternalFrame implements ActionListener {

	private JPanel jpWith = new JPanel();
	private JLabel Date,AccountNu,Amount,Period,Mode,Interest;
	private JTextField TAccountNu,TAmount,TPeriod,TMode,TInterest;
